...
export function Team() {
    ...
    return (
        <section className="w-full py-20 bg-brand-dark" id="team">
                    ...
                    {teamMembers.map((member, index) => (
                        <div key={index} className="flex gap-6 group">
                            <div className="shrink-0">
                                {member.imageUrl ? (
                                    <div className="w-24 h-24 rounded-full bg-brand-slate border-2 border-brand-yellow flex items-center justify-center overflow-hidden relative">
                                        <Image src={member.imageUrl} alt={member.name} fill className="object-cover" />
                                    </div>
                                ) : (
                                    <div className="w-24 h-24 rounded-full bg-brand-slate border-2 border-brand-yellow flex items-center justify-center overflow-hidden">
                            ...
                            <div className="space-y-2 pt-2">
                                <div>
                                    ...
                                    <p className="text-brand-yellow font-bold tracking-wide">{member.role}</p>
                                </div>
